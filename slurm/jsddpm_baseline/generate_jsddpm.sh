...
# ========================================================================
# JS-DDPM Generation Script for SLURM
# ========================================================================
# This script generates synthetic FLAIR/lesion samples from a trained model
#
# Usage:
#   sbatch slurm/generate_jsddpm.sh <checkpoint_path>
#
# Example:
#   sbatch slurm/generate_jsddpm.sh /path/to/checkpoint.ckpt
#
# The checkpoint should be from a training run (e.g., jsddpm-epoch=0050-val_loss=0.1234.ckpt)
# ========================================================================
...
if [ $# -eq 0 ]; then
    ...
    echo "Usage: sbatch slurm/generate_jsddpm.sh <checkpoint_path>"
    exit 1
fi
CHECKPOINT_PATH="$1"
...
# Typically: /path/to/results/jsddpm/checkpoints/model.ckpt
