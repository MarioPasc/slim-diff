#!/usr/bin/env bash
#SBATCH -J log_generate_jsddpm_complete
...
#
# Usage:
#   sbatch slurm/lesion_replication_fix_experiments/jsddpm_complete/generate_jsddpm.sh <checkpoint_path>
#
# Example:
#   sbatch slurm/lesion_replication_fix_experiments/jsddpm_complete/generate_jsddpm.sh /path/to/checkpoint.ckpt
# ========================================================================
...
# CONFIGURATION
# ========================================================================
EXPERIMENT_NAME="jsddpm_complete"
