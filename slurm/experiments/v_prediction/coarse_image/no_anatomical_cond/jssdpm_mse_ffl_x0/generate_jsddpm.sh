#!/usr/bin/env bash
#SBATCH -J log_generate_jssdpm_mse_ffl_x0
...
# ========================================================================
# JS-DDPM Generation Script for Complete Experiment
# ========================================================================
# This script generates synthetic FLAIR/lesion samples from the complete
# Lp norm + FFL trained model
#
# Usage:
#   sbatch slurm/lesion_replication_fix_experiments/jssdpm_mse_ffl_x0/generate_jsddpm.sh <checkpoint_path>
#
# Example:
#   sbatch slurm/lesion_replication_fix_experiments/jssdpm_mse_ffl_x0/generate_jsddpm.sh /path/to/checkpoint.ckpt
# ========================================================================
...
# CONFIGURATION
# ========================================================================
EXPERIMENT_NAME="jssdpm_mse_ffl_x0"
