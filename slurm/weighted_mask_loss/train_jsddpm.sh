#!/usr/bin/env bash
#SBATCH -J log_weighted_mask_train_jsddpm_flair_soco
...
# ========================================================================
EXPERIMENT_NAME="jsddpm_weighted_mask_loss"
...
CONFIG_FILE="${REPO_SRC}/slurm/weighted_mask_loss/${EXPERIMENT_NAME}.yaml"
