#!/usr/bin/env bash
#SBATCH -J log_generate_jssdpm_lp_ffl
...
#
# Usage:
#   sbatch slurm/lesion_replication_fix_experiments/jssdpm_lp_ffl/generate_jsddpm.sh <checkpoint_path>
#
# Example:
#   sbatch slurm/lesion_replication_fix_experiments/jssdpm_lp_ffl/generate_jsddpm.sh /path/to/checkpoint.ckpt
# ========================================================================
