#!/usr/bin/env bash
#SBATCH -J log_jsddpm_sinusoidal_embeddings_kendall
...
# ========================================================================
EXPERIMENT_NAME="jsddpm_sinusoidal_embeddings_kendall"
...
CONFIG_FILE="${REPO_SRC}/slurm/sinusoidal_embeddings_kendall/${EXPERIMENT_NAME}.yaml"
