#!/usr/bin/env bash
#SBATCH -J self_cond_p_0.5_velocity
...
# ========================================================================
EXPERIMENT_NAME="self_cond_p_0.5_velocity"
...
CONFIG_FILE="${REPO_SRC}/slurm/icip2026/self_cond_ablation/self_cond_p_0.5/v_lp_2.0/self_cond_p_0.5_velocity_lp_2.0.yaml"
