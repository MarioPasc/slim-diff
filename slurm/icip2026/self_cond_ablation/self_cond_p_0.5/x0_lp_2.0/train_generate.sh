...
# ========================================================================
EXPERIMENT_NAME="self_cond_p_0.5_x0"
...
CONFIG_FILE="${REPO_SRC}/slurm/icip2026/self_cond_ablation/self_cond_p_0.5/x0_lp_2.0/self_cond_p_0.5_x0_lp_2.0.yaml"
