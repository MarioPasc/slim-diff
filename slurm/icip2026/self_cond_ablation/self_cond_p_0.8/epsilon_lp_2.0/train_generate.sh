#!/usr/bin/env bash
#SBATCH -J self_cond_p_0.8_epsilon
...
# ========================================================================
EXPERIMENT_NAME="self_cond_p_0.8_epsilon"
...
CONFIG_FILE="${REPO_SRC}/slurm/icip2026/self_cond_ablation/self_cond_p_0.8/epsilon_lp_2.0/self_cond_p_0.8_epsilon_lp_2.0.yaml"
