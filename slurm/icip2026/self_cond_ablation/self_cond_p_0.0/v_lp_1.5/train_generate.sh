#!/usr/bin/env bash
#SBATCH -J self_cond_p_0.0_velocity_lp_1.5
...
# ========================================================================
EXPERIMENT_NAME="self_cond_p_0.0_velocity_lp_1.5"
...
CONFIG_FILE="${REPO_SRC}/slurm/icip2026/self_cond_ablation/self_cond_p_0.0/v_lp_1.5/self_cond_p_0.0_velocity_lp_1.5.yaml"
