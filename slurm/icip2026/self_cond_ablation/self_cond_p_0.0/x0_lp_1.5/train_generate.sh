#!/usr/bin/env bash
#SBATCH -J self_cond_p_0.0_x0_lp_1.5
...
# ========================================================================
EXPERIMENT_NAME="self_cond_p_0.0_x0_lp_1.5"
...
CONFIG_FILE="${REPO_SRC}/slurm/icip2026/self_cond_ablation/self_cond_p_0.0/x0_lp_1.5/self_cond_p_0.0_x0_lp_1.5.yaml"
