#!/usr/bin/env bash
#SBATCH -J self_cond_p_0.0_epsilon_lp_2.5
...
# ========================================================================
EXPERIMENT_NAME="self_cond_p_0.0_epsilon_lp_2.5"
...
CONFIG_FILE="${REPO_SRC}/slurm/icip2026/self_cond_ablation/self_cond_p_0.0/epsilon_lp_2.5/self_cond_p_0.0_epsilon_lp_2.5.yaml"
