#!/usr/bin/env bash
#SBATCH -J iwinac_sc_p0.7_x0_lp1.5
...
# ========================================================================
EXPERIMENT_NAME="iwinac_sc_p0.7_x0_lp1.5"
...
CONFIG_FILE="${REPO_SRC}/slurm/iwinac2026/self_cond_probability_ablation/x0_lp_1.5/self_cond_p_0.7/iwinac_sc_p0.7_x0_lp1.5.yaml"
