#!/usr/bin/env bash
#SBATCH -J iwinac_pmf_B3c_x0_loss_lpips_1.0
...
# ========================================================================
EXPERIMENT_NAME="iwinac_pmf_B3c_x0_loss_lpips_1.0"
...
CONFIG_FILE="${REPO_SRC}/slurm/iwinac2026/pMF_style_loss/B3_x0_pred_x0_loss_lpips/lambda_1.0/config.yaml"
