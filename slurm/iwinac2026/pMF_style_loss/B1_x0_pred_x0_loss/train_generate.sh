#!/usr/bin/env bash
#SBATCH -J iwinac_pmf_B1_x0_pred_x0_loss
...
# ========================================================================
EXPERIMENT_NAME="iwinac_pmf_B1_x0_pred_x0_loss"
...
CONFIG_FILE="${REPO_SRC}/slurm/iwinac2026/pMF_style_loss/B1_x0_pred_x0_loss/config.yaml"
