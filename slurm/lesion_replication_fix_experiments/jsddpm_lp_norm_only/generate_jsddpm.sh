#!/usr/bin/env bash
#SBATCH -J log_generate_jsddpm_lp_norm_only
...
# ========================================================================
# JS-DDPM Generation Script for Lp Norm Only Experiment
# ========================================================================
# This script generates synthetic FLAIR/lesion samples from the
# Lp norm only trained model (no FFL ablation study)
#
# Usage:
#   sbatch slurm/lesion_replication_fix_experiments/jsddpm_lp_norm_only/generate_jsddpm.sh <checkpoint_path>
#
# Example:
#   sbatch slurm/lesion_replication_fix_experiments/jsddpm_lp_norm_only/generate_jsddpm.sh /path/to/checkpoint.ckpt
# ========================================================================
...
if [ $# -eq 0 ]; then
    ...
    echo "Usage: sbatch slurm/lesion_replication_fix_experiments/jsddpm_lp_norm_only/generate_jsddpm.sh <checkpoint_path>"
    exit 1
fi
CHECKPOINT_PATH="$1"
