#!/usr/bin/env bash
#SBATCH -J xai_ablation_no_selfcond
...
# ========================================================================
EXPERIMENT_NAME="xai_ablation_no_selfcond"
...
CONFIG_FILE="${REPO_SRC}/slurm/ablation_study_xai/ablation_no_selfcond/ablation_no_selfcond.yaml"
...
echo "  (Proposal with self_cond=0.5 — tests LF texture via self-conditioning)"
echo "=========================================================================="
echo ""
echo "Timing:"
