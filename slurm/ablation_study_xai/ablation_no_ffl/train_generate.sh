...
# ========================================================================
EXPERIMENT_NAME="xai_ablation_no_ffl"
...
CONFIG_FILE="${REPO_SRC}/slurm/ablation_study_xai/ablation_no_ffl/ablation_no_ffl.yaml"
...
echo "  (Proposal without FFL — tests HF correction contribution)"
echo "=========================================================================="
echo ""
echo "Timing:"
